class Api::V1::CollectionsController < Api::V1::BaseController
  ...
  def index
    respond_to do |format|
      format.json { render json: { data: current_user.collections, errors: [] } }
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      format.json { render json: { data: collection, errors: collection.errors }, status: status_code, location: nil }
    end
  end
  ...
  def show
    ...
    respond_to do |format|
      format.json { render json: { data: collection, errors: collection.errors } }
    end
  end
  ...
  def update
    ...
    respond_to do |format|
      format.json { render json: { data: collection, errors: collection.errors }, status: status_code }
    end
  end
